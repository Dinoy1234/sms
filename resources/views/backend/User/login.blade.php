               ...
               <div class="loginbox">
                  ...
                  <div class="login-right">
                     <div class="login-right-wrap">
                        ...
                        <form action="{{route('login.view')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                        ...
                        <div class="text-center dont-have">For student <a href="{{route('user.registration')}}">Register Now</a></div>
                     </div>
                  </div>
               </div>
            </div>
